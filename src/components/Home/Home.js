...
const Home = () => {
  return (
    <div className='w-full m-auto'>
        ...
        <ImageBtn route={`all/${Math.floor(Math.random()*10)}`} title={'ROLL DICE'} src={'https://static.nike.com/a/images/f_auto/dpr_1.0,cs_srgb/w_1584,c_limit/957a33a3-83b5-4c7d-a482-c2e41005f3f1/marca-jordan.png'}/>
    </div>
  )
}
